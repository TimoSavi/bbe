...
void write_buffer(unsigned char *,off_t);
...
void init_commands(struct commands *);

void close_commands(struct commands *);

void close_output_stream();

void write_w_command(unsigned char *,size_t);

void execute_program(struct commands *);
